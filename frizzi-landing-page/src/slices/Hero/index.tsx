      ...
      <div className="grid">
        <div className="grid h-screen place-items-center">
          <div className="grid auto-rows-min place-items-center text-center">
            ...
            <div className="hero-body mt-4 text-2xl text-sky-950">
        ...
        <div className="text-side relative z-[80] grid h-screen items-center gap-4 md:grid-cols-2">
          ...
          <div>
            <TextSplitter
              className="text-side-heading text-6xl font-black text-balance text-sky-950 uppercase lg:text-8xl"
              text={asText(slice.primary.second_heading)}
            />
            <div className="text-side-body mt-4 max-w-xl text-xl text-balance text-sky-950">
